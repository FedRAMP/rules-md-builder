...
This repository tracks the `pwx` branch of `FedRAMP/rules` as a git submodule at `rules` so the source material stays owned upstream instead of being edited here.
